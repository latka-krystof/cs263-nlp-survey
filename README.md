...
*Figure 3: Quantitative results on the three POPE evaluation subsets using the LLaVA-v1.5 (7B) model. The proposed OA-VCD method ("Ours") consistently achieves the highest Accuracy and F1 scores across all settings compared to Regular decoding, standard VCD, and the AGLA baseline.*
